...
#PJM -o /work/gu14/k36093/energy_norm/result_imagenet_org.txt
#PJM -g gu14
#PJM -j
#PJM --fs /work
#PJM -m b,s
...
/work/gu14/k36093/.pyenv/versions/3.8.0/envs/hello_world/bin/python /work/gu14/k36093/energy_norm/src/resnet18_imagenet.py --train_epochs 70 --retrain_epochs 50 --num_iters 3 --num_tasks 10 --num_classes 1000 --num_classes_per_task 100 --test_batch_size 100 
