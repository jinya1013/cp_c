...
#PJM -o /work/gu14/k36093/energy_norm/result_energy_maks_count.txt
#PJM -g gu14
#PJM -j
#PJM --fs /work
#PJM -m b,s
...
# /work/gu14/k36093/.pyenv/versions/3.8.0/envs/hello_world/bin/python /work/gu14/k36093/energy_norm/src/main.py --train_epochs 70 --retrain_epochs 50 --num_iters 3 --num_tasks 2 --num_classes 100 --num_classes_per_task 50 --dataset_name cifar100 --test_batch_size 5  --task_select_method free_energy --load_path /work/gu14/k36093/energy_norm/results/cifar100-resnet18/20_tasks/2023-07-07 07:24
...
/work/gu14/k36093/.pyenv/versions/3.8.0/envs/hello_world/bin/python /work/gu14/k36093/energy_norm/src/main_eval.py --train_epochs 70 --retrain_epochs 50 --num_iters 3 --num_tasks 20 --num_classes 100 --num_classes_per_task 5 --dataset_name cifar100 --test_batch_size 5  --task_select_method free_energy --load_path "/work/gu14/k36093/energy_norm/results/cifar100-resnet18/20_tasks/2023-07-07 07:24/"
